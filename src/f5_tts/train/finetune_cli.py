...
def main():
    ...
    checkpoint_path = f"./ckpts/{args.dataset_name}"

    # Model parameters based on experiment name

    if args.exp_name == "F5TTS_V2_Base":
        ...
        if args.finetune:
            if args.pretrain is None:
                ckpt_path = str(cached_path("hf://VIZINTZOR/F5-TTS-TH-V2/model_250000.pt"))
            else:
        ...
        if args.finetune:
            if args.pretrain is None:
                ckpt_path = str(cached_path("hf://VIZINTZOR/F5-TTS-TH-V2/model_1000000.pt"))
            else:
                ckpt_path = args.pretrain
